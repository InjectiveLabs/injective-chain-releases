...
Following [proposal 198](https://hub.injective.network/proposals/198/), this indicates that the upgrade procedure should be performed on block number `24135000`.
...
The Injective Chain 10008 will undergo a scheduled upgrade to Injective Chain 10009 release on  **January 17th 2023 14:00 UTC**.

The following is a short summary of the upgrade steps:

1. Vote and wait until the node panics at block height 24134999.
2. Backing up configs, data, and keys used for running the Injective Chain.
3. Install the [Injective Chain 10009 release](https://github.com/InjectiveLabs/injective-chain-releases/releases/tag/v1.8.0-1668679102 -PLACEHOLDER)
...
3. Download and install the injective-chain `10009 release`
   ```bash
   wget https://github.com/InjectiveLabs/injective-chain-releases/releases/download/v1.8.0-1668679102/linux-amd64.zip -PLACEHOLDER
   unzip linux-amd64.zip
   sudo mv injectived peggo /usr/bin
   sudo mv libwasmvm.x86_64.so /usr/lib
   ```

4. Verify you are currently running the correct version (`-PLACEHOLDER`) of `injectived` after downloading the 10009 release:
    ```bash
   injectived version
   Version dev (-PLACEHOLDER)
